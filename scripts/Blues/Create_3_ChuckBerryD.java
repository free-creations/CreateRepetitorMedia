 ...
 */
public class Create_3_ChuckBerryD {
  ...
  final static private String description = "Chuck Berry D";
  final static private String number = "3";
  final static private String camelTitle = "ChuckBerryD";
  final static private int resolution = 480;

  private Create_3_ChuckBerryD() throws IOException {
    loggingHandler = null;

    orchestraFileURL = this.getClass().getResource("resources/ChuckBerryD.mid");
    if (orchestraFileURL == null) {
      throw new RuntimeException("ChuckBerryD.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_3_ChuckBerryD processor = new Create_3_ChuckBerryD();
