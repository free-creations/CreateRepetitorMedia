 ...
 */
public class Create_1_BluesInD {
  ...
  final static private String description = "Blues in D";
  final static private String number = "1";
  final static private String camelTitle = "BluesInD";
  final static private int resolution = 480;

  private Create_1_BluesInD() throws IOException {
    loggingHandler = null;

    orchestraFileURL = this.getClass().getResource("resources/bluesInDSlow.mid");
    if (orchestraFileURL == null) {
      throw new RuntimeException("bluesInD.mid file not found.");
    }
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    //... Bass track 5
    masterSequence = TrackMerger.process(masterSequence, orchestraSequence, new int[]{2}, -1, "Drums", loggingHandler); //
    ...
    voicesSuperTrack.setName("Drums");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_1_BluesInD processor = new Create_1_BluesInD();
