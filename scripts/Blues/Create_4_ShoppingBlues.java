 ...
 */
public class Create_4_ShoppingBlues {

  private final URL orchestraFileURL;
  ...
  final static private String description = "ShoppingBlues";
  ...
  private Create_4_ShoppingBlues() throws IOException {
    loggingHandler = null;

    orchestraFileURL = this.getClass().getResource("resources/ShoppingBluesOrchestra.mid");
    if (orchestraFileURL == null) {
      throw new RuntimeException("ShoppingBlues.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_4_ShoppingBlues processor = new Create_4_ShoppingBlues();
