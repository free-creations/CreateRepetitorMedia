 ...
 */
public class Create_04_WatZal {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "VanEyck";
  final static private String description = "VanEyck";
  final static private String number = "04";
  final static private String camelTitle = "VanEyck";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/VanEyck/resources");

  private Create_04_WatZal() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "vanEyck-o.mid");
    if (!inputFile.exists()) {
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    voiceBase++; //3
    newSongTrack = new MidiTrack();
    newSongTrack.setName("Variante 1");
    newSongTrack.setMidiTrackIndex(voiceBase);
    ...
    voiceBase++; //4
    newSongTrack = new MidiTrack();
    newSongTrack.setName("Variante 2");
    newSongTrack.setMidiTrackIndex(voiceBase);
    newSongTrack.setMidiChannel(1);
    newSongTrack.setInstrumentDescription("Piano");
    newSongTrack.setMute(true);
...
// -- 
    voiceBase++; //5
    newSongTrack = new MidiTrack();
    newSongTrack.setName("Variante 3");
    newSongTrack.setMidiTrackIndex(voiceBase);
    newSongTrack.setMidiChannel(1);
    newSongTrack.setInstrumentDescription("Piano");
    newSongTrack.setMute(true);
...
// -- 
    voiceBase++; //6
    newSongTrack = new MidiTrack();
    newSongTrack.setName("Variante 4");
    newSongTrack.setMidiTrackIndex(voiceBase);
    newSongTrack.setMidiChannel(1);
    newSongTrack.setInstrumentDescription("Piano");
    newSongTrack.setMute(true);
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_04_WatZal processor = new Create_04_WatZal();
