 ...
 */
public class Create_04_WatZalVariante2 {
  ...
  final static private String description = "VanEyckVar2";
  final static private String number = "02";
  final static private String camelTitle = "VanEyckVar2";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/VanEyck/resources");

  private Create_04_WatZalVariante2() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "variante_2.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_04_WatZalVariante2 processor = new Create_04_WatZalVariante2();
