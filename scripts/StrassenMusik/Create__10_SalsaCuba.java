 ...
 */
public class Create__10_SalsaCuba {
  ...
  final static private String description = "Salsa Cuba";
  final static private String number = "10";
  final static private String camelTitle = "SalsaCuba";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "10_SalsaCubaOrchestra.mid";

  private Create__10_SalsaCuba() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__10_SalsaCuba processor = new Create__10_SalsaCuba();
