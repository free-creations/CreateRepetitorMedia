...
public class Create_3_CappuccinoRag {
  ...
  final static private String description = "CappuccinoRag";
  final static private String number = "3";
  final static private String camelTitle = "CappuccinoRag";
  ...
  private Create_3_CappuccinoRag() throws IOException {
    ...
    inputFile = new File(resourceDir, "CappuccinoRagOrchestra.mid");
    if (!inputFile.exists()) {
