 ...
 */
public class Create_3_CappuccinoRag {
  ...
  final static private String description = "Capuccino Rag";
  final static private String number = "3";
  final static private String camelTitle = "CapuccinoRag";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "03_CappuccinoRagOrchestra.mid";

  private Create_3_CappuccinoRag() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_3_CappuccinoRag processor = new Create_3_CappuccinoRag();
