 ...
 */
public class Create__12_AtTheBazaar {
  ...
  final static private String description = "At The Basar";
  final static private String number = "12";
  final static private String camelTitle = "AtTheBasar";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "12_AtTheBasarOrchestra.mid";

  private Create__12_AtTheBazaar() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__12_AtTheBazaar processor = new Create__12_AtTheBazaar();
