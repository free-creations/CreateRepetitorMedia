 ...
 */
public class Create__21_TangoLatino {
  ...
  final static private String description = "Tango Latino";
  final static private String number = "21";
  final static private String camelTitle = "TangoLatino";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "21_TangoLatinoOrchestra.mid";

  private Create__21_TangoLatino() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__21_TangoLatino processor = new Create__21_TangoLatino();
