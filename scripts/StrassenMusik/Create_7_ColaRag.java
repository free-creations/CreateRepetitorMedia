...
public class Create_7_ColaRag {
  ...
  final static private String description = "Cola Rag";
  final static private String number = "7";
  final static private String camelTitle = "ColaRag";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "07_ColaRagOrchestra.mid";

  private Create_7_ColaRag() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_7_ColaRag processor = new Create_7_ColaRag();
