 ...
 */
public class Create__16_MyFirstBicycle {
  ...
  final static private String description = "MyFirstBicycle";
  final static private String number = "16";
  final static private String camelTitle = "MyFirstBicycle";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "16_MyFirstBicycleOrchestra.mid";

  private Create__16_MyFirstBicycle() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__16_MyFirstBicycle processor = new Create__16_MyFirstBicycle();
