 ...
 */
public class Create__19_DesireForFortune {
  ...
  final static private String description = "Desire For Fortune";
  final static private String number = "19";
  final static private String camelTitle = "DesireForFortune";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "19_DesireForFortuneOrchestra.mid";

  private Create__19_DesireForFortune() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__19_DesireForFortune processor = new Create__19_DesireForFortune();
