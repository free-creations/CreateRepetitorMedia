 ...
 */
public class Create__20_PizzaRag {
  ...
  final static private String description = "Pizza Rag";
  final static private String number = "20";
  final static private String camelTitle = "PizzaRag";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "20_PizzaRagOrchestra.mid";

  private Create__20_PizzaRag() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__20_PizzaRag processor = new Create__20_PizzaRag();
