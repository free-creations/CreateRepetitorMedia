 ...
 */
public class Create__13_NoExchange {
  ...
  final static private String description = "No Exchange";
  final static private String number = "13";
  final static private String camelTitle = "NoExchange";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "13_NoExchangeOrchestra.mid";

  private Create__13_NoExchange() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__13_NoExchange processor = new Create__13_NoExchange();
