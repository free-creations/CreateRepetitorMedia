 ...
 */
public class Create__15_CafeAuLait {
  ...
  final static private String description = "Cafe au lait";
  final static private String number = "15";
  final static private String camelTitle = "CafeAuLait";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "15_CafeAuLaitOrchestra.mid";

  private Create__15_CafeAuLait() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__15_CafeAuLait processor = new Create__15_CafeAuLait();
