...
public class Create_6_Mexico {
  ...
  final static private String description = "Mexico";
  final static private String number = "6";
  final static private String camelTitle = "Mexico";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "06_MexicoOrchestra.mid";

  private Create_6_Mexico() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_6_Mexico processor = new Create_6_Mexico();
