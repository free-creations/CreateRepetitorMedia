 ...
 */
public class Create__22_SmileAWhile {
  ...
  final static private String description = "Smile a While";
  final static private String number = "22";
  final static private String camelTitle = "SmileAWhile";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "22_SmileAWhileOrchestra.mid";

  private Create__22_SmileAWhile() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__22_SmileAWhile processor = new Create__22_SmileAWhile();
