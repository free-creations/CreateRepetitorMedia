 ...
 */
public class Create__11_LimoRag {
  ...
  final static private String description = "Limo Rag";
  final static private String number = "11";
  final static private String camelTitle = "LimoRag";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "11_LimoRagOrchestra.mid";

  private Create__11_LimoRag() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__11_LimoRag processor = new Create__11_LimoRag();
