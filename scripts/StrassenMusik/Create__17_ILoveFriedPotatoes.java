 ...
 */
public class Create__17_ILoveFriedPotatoes {
  ...
  final static private String description = "I Love Fried Potatoes";
  final static private String number = "17";
  final static private String camelTitle = "ILoveFriedPotatoes";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "17_ILoveFriedPotatoesOrchestra.mid";

  private Create__17_ILoveFriedPotatoes() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__17_ILoveFriedPotatoes processor = new Create__17_ILoveFriedPotatoes();
