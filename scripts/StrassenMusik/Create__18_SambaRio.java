 ...
 */
public class Create__18_SambaRio {
  ...
  final static private String description = "Samba Rio";
  final static private String number = "18";
  final static private String camelTitle = "SambaRio";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "18_SambaRioOrchestra.mid";

  private Create__18_SambaRio() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__18_SambaRio processor = new Create__18_SambaRio();
