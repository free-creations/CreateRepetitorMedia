 ...
 */
public class Create__14_SouldOut {
  ...
  final static private String camelTitle = "SouldOut";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "14_SouldOutOrchestra.mid";

  private Create__14_SouldOut() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create__14_SouldOut processor = new Create__14_SouldOut();
