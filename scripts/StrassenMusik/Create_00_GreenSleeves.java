 ...
 */
public class Create_00_GreenSleeves {
  ...
  final static private String description = "Green Sleeves";
  final static private String number = "00";
  ...
  private Create_00_GreenSleeves() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "00_GreenSleeves.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_00_GreenSleeves processor = new Create_00_GreenSleeves();
