 ...
 */
public class Create_9_CoffeetimeBlues {
  ...
  final static private String description = "Coffeetime Blues";
  final static private String number = "9";
  final static private String camelTitle = "CoffeetimeBlues";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "09_CoffeetimeBluesOrchestra.mid";

  private Create_9_CoffeetimeBlues() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_9_CoffeetimeBlues processor = new Create_9_CoffeetimeBlues();
