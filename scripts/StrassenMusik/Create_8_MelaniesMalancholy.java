 ...
 */
public class Create_8_MelaniesMalancholy {
  ...
  final static private String description = "Melanies Melancholy";
  final static private String number = "8";
  final static private String camelTitle = "MelaniesMelancholy";
  final static private int resolution = 480;
  static final private File resourceDir = new File("/home/harald/Music/StrassenMusik");
  static final private String inputFileName = "08_MelaniesMelancholyOrchestra.mid";

  private Create_8_MelaniesMalancholy() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_8_MelaniesMalancholy processor = new Create_8_MelaniesMalancholy();
