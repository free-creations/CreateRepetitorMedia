 ...
 */
public class Create_13_HeuteIstDasHeilGekommen {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "13_TodaySalvationHasCome";
  final static private String description = "13_TodaySalvationHasCome";
  final static private int resolution = 480;
  static final private File resourceDir = new File("../rachmaninow-vigil");

  private Create_13_HeuteIstDasHeilGekommen() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_13_HeuteIstDasHeilGekommen processor = new Create_13_HeuteIstDasHeilGekommen();
