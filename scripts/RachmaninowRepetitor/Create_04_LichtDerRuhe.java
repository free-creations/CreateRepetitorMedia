 ...
 */
public class Create_04_LichtDerRuhe {
  ...
  final static private String description = "04_OGladsomeLight";
  final static private int resolution = 480;
  static final private File resourceDir = new File("../rachmaninow-vigil");

  private Create_04_LichtDerRuhe() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_04_LichtDerRuhe processor = new Create_04_LichtDerRuhe();
