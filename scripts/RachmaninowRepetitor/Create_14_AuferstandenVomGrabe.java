 ...
 */
public class Create_14_AuferstandenVomGrabe {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "14_ThouDidstRiseFromTheTomb";
  final static private String description = "14_ThouDidstRiseFromTheTomb";
  final static private int resolution = 480;
  static final private File resourceDir = new File("../rachmaninow-vigil");

  private Create_14_AuferstandenVomGrabe() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_14_AuferstandenVomGrabe processor = new Create_14_AuferstandenVomGrabe();
