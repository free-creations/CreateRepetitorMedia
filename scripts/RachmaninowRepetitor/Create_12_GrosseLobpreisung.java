 ...
 */
public class Create_12_GrosseLobpreisung {
  ...
  final static private String description = "12_GreatGloria";
  final static private int resolution = 480;
  static final private File resourceDir = new File("../rachmaninow-vigil");

  private Create_12_GrosseLobpreisung() throws IOException {
    loggingHandler = null;
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_12_GrosseLobpreisung processor = new Create_12_GrosseLobpreisung();
