 ...
 */
public class Create_15_SiegbringendeHeerführerin {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "15_ToTheeTheVictoriousLeader";
  final static private String description = "15_ToTheeTheVictoriousLeader";
  final static private int resolution = 480;
  static final private File resourceDir = new File("../rachmaninow-vigil");

  private Create_15_SiegbringendeHeerführerin() throws IOException {
    loggingHandler = null;
    File projectDir = new File(resourceDir, piece+"/festival");
    ...
    inputFile = new File(projectDir, "Festival.mid");
    if (!inputFile.exists()) {
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    for (int i = 24; i < inputSequence.getTracks().length; i++) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_15_SiegbringendeHeerführerin processor = new Create_15_SiegbringendeHeerführerin();
