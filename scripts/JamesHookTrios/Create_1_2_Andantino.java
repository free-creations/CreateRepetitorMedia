 ...
 */
public class Create_1_2_Andantino {
  ...
  final static private String description = "Trio I-2, Andantino ";
  final static private String number = "1_2";
  final static private String camelTitle = "Andantino";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/JamesHookTrios/resources");
  
  
  private Create_1_2_Andantino() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "Trio_1_2-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_1_2_Andantino processor = new Create_1_2_Andantino();
