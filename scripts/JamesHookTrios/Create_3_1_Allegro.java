 ...
 */
public class Create_3_1_Allegro {
  ...
  final static private String description = "Trio III-1, Allegro ";
  final static private String number = "3_1";
  ...
  private Create_3_1_Allegro() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "Trio_3_1-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_3_1_Allegro processor = new Create_3_1_Allegro();
