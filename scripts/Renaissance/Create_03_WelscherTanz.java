 ...
 */
public class Create_03_WelscherTanz {
  ...
  final static private String camelTitle = "WelscherTanz";
  final static private int resolution = 480;

  private Create_03_WelscherTanz() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "03_WelscherTanz-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("03_WelscherTanz-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_03_WelscherTanz processor = new Create_03_WelscherTanz();
