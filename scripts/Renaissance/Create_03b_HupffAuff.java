 ...
 */
public class Create_03b_HupffAuff {

  private File orchestraFile;
  private static final File resourceDir = new File("scripts/LeichteStueckeDerVorklassik/resources");
  private File outputMidiFile;
  private File outputSongFile;
  private Handler loggingHandler;
  final static private String piece = "Vorklassig";
  final static private String description = "Newsidler Welscher Tanz";
  final static private String number = "03b";
  final static private String camelTitle = "HupffAuff";
  final static private int resolution = 480;

  private Create_03b_HupffAuff() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "03b_HupffAuff-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("03b_HupffAuff-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_03b_HupffAuff processor = new Create_03b_HupffAuff();
