 ...
 */
public class Create_01_Preambel {
  ...
  final static private String description = "Newsidler Preambel";
  final static private String number = "01";
  final static private String camelTitle = "Preambel";
  final static private int resolution = 480;

  private Create_01_Preambel() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "01_Preambel.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("01_Preambel.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_01_Preambel processor = new Create_01_Preambel();
