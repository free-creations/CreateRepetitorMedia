 ...
 */
public class Create_01_VenusDuUndDeinKind {
  ...
  final static private String piece = "Regnard";
  final static private String description = "VenusDuUndDeinKind";
  final static private String number = "01";
  final static private String camelTitle = "VenusDuUndDeinKind";
  final static private int resolution = 480;

  private Create_01_VenusDuUndDeinKind() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "01_VenusDuUndDeinKindSheet.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("01_VenusDuUndDeinKindSheet.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_01_VenusDuUndDeinKind processor = new Create_01_VenusDuUndDeinKind();
