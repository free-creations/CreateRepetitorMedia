 ...
 */
public class Create_15Spagnoletta {
  ...
  final static private String description = "Negri Spagnoletta";
  final static private String number = "15";
  final static private String camelTitle = "Spagnoletto";
  final static private int resolution = 480;

  private Create_15Spagnoletta() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "15_Spagnoletto-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("15_Spagnoletto-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_15Spagnoletta processor = new Create_15Spagnoletta();
