 ...
 */
public class Create_16Spagnoletta {
  ...
  final static private String description = "Rasponi Spagnoletta";
  final static private String number = "16";
  final static private String camelTitle = "Spagnoletta";
  final static private int resolution = 480;

  private Create_16Spagnoletta() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "16_Spagnoletta-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("16_Spagnoletta-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_16Spagnoletta processor = new Create_16Spagnoletta();
