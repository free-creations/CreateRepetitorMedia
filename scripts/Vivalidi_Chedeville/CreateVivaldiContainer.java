 ...
 * @author harald
 */
public class CreateVivaldiContainer {

  private static final File tempDir = new File("../temp");
  private static final String outFilename = "Vivaldi_6.fmc";
  ...
  private static ZipItem[] files = new ZipItem[]{
    ...
    new ZipItem(
    new File(tempDir, "Vivaldi_6/1_AllaBreve.mid"),
    "Vivaldi_6/1_AllaBreve.mid",
    false),
    // ---- 1 Gravement.xml (create with Create_1_Gravement.java)
    new ZipItem(
    new File(tempDir, "Vivaldi_6/1_AllaBreve.xml"),
    "Vivaldi_6/1_AllaBreve.xml",
    true),};

  private CreateVivaldiContainer() {
  ...
  public static void main(String[] args) throws Exception {
    CreateVivaldiContainer processor = new CreateVivaldiContainer();
