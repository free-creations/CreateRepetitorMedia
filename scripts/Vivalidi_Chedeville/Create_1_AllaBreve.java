 ...
 */
public class Create_1_AllaBreve {

  private File orchestraFile;
  private static final File resourceDir = new File("scripts/Vivalidi_Chedeville/resources");
  private File outputMidiFile;
  private File outputSongFile;
  private Handler loggingHandler;
  final static private String piece = "Vivaldi_6";
  final static private String description = "Vivaldi/Chedeville Sonate VI";
  final static private String number = "1";
  final static private String camelTitle = "AllaBreve";
  final static private int resolution = 480;

  private Create_1_AllaBreve() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "solo.mid");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_1_AllaBreve processor = new Create_1_AllaBreve();
