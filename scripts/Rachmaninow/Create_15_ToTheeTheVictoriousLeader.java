 ...
 */
public class Create_15_ToTheeTheVictoriousLeader {
  ...
  final static private String variant = "festival";
  final static private int resolution = 480;
  static final private File resourceDir = new File("../rachmaninow-vigil");

  private Create_15_ToTheeTheVictoriousLeader() throws IOException {
    loggingHandler = null;
    ...
    outputMidiFile = new File(projectDir, "FestivalNice.mid");
...
// Write the file to disk
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_15_ToTheeTheVictoriousLeader processor = new Create_15_ToTheeTheVictoriousLeader();
