 ...
 */
public class Create_03_Partita1Aa_CDurVerziert {
  ...
  final static private String camelTitle = "Aria4_CDurVerziert";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Telemann/resources");

  private Create_03_Partita1Aa_CDurVerziert() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "Partita_1A4-CDurVerziert-o.mid");
    if (!inputFile.exists()) {
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    newSongTrack.setName("Oranaments");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_03_Partita1Aa_CDurVerziert processor = new Create_03_Partita1Aa_CDurVerziert();
