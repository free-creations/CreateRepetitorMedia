 ...
 */
public class Create_04_Partita1Aa_CDurBegleitung {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "TelemannPartita";
  final static private String description = "Telemann Partita 1";
  final static private String number = "04";
  final static private String camelTitle = "Aria4_CDurBegleitung";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Telemann/resources");

  private Create_04_Partita1Aa_CDurBegleitung() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "Partita_1A4-CDurEinfacheBegleitung-o.mid");
    if (!inputFile.exists()) {
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    // add track 6; the metronome track
    ...
    voiceBase++; //6
    newSongTrack = new MidiTrack();
    newSongTrack.setName("right Hand");
    newSongTrack.setMidiTrackIndex(voiceBase);
    ...
    voiceBase++; //8
    newSongTrack = new MidiTrack();
    newSongTrack.setName("middleVoice");
    newSongTrack.setMidiTrackIndex(voiceBase);
    newSongTrack.setMidiChannel(1);
    newSongTrack.setInstrumentDescription("Piano");
    newSongTrack.setMute(true);
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_04_Partita1Aa_CDurBegleitung processor = new Create_04_Partita1Aa_CDurBegleitung();
