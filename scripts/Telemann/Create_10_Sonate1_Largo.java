 ...
 */
public class Create_10_Sonate1_Largo {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "TelemannSonate1";
  final static private String description = "Sonate Nr. 1 in F-Dur";
  final static private String number = "10";
  final static private String camelTitle = "Sonate_1_Largo";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Telemann/resources");

  private Create_10_Sonate1_Largo() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "Georg-Philipp-Telemann-Sonate-Nr-1-in-F-DurLargo.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_10_Sonate1_Largo processor = new Create_10_Sonate1_Largo();
