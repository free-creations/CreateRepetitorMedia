 ...
 */
public class Create_01_Partita1Aa_CDur {
  ...
  final static private String camelTitle = "Aria4_CDur";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Telemann/resources");

  private Create_01_Partita1Aa_CDur() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "Partita_1A4-CDur-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_01_Partita1Aa_CDur processor = new Create_01_Partita1Aa_CDur();
