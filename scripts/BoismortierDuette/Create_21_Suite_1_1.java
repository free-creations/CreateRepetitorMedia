 ...
 */
public class Create_21_Suite_1_1 {
  ...
  final static private String description = "Suite I, 1 Allemande";
  ...
  private Create_21_Suite_1_1() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "21_suite_1_1-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("21_suite_1_1-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_21_Suite_1_1 processor = new Create_21_Suite_1_1();
