 ...
 */
public class Create_05_Menuet_1 {
  ...
  final static private String description = "Menuet_1";
  final static private String number = "05";
  final static private String camelTitle = "Menuet_1";
  final static private int resolution = 480;

  private Create_05_Menuet_1() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "05_Menuet_1-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("05_Menuet_1-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_05_Menuet_1 processor = new Create_05_Menuet_1();
