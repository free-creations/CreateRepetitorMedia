 ...
 */
public class Create_12_Rigaudon_2 {
  ...
  final static private String description = "Rigaudon 2";
  final static private String number = "12";
  final static private String camelTitle = "Rigaudon_2";
  final static private int resolution = 480;

  private Create_12_Rigaudon_2() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "12_Rigaudon_2-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("12_Rigaudon_2-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_12_Rigaudon_2 processor = new Create_12_Rigaudon_2();
