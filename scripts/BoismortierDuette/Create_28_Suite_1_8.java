 ...
 */
public class Create_28_Suite_1_8 {
  ...
  final static private String description = "Suite I, 1er Rigaudon";
  final static private String number = "28";
  final static private String camelTitle = "Rigaudon_1";
  final static private int resolution = 480;

  private Create_28_Suite_1_8() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "28_suite_1_8-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("28_suite_1_8-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_28_Suite_1_8 processor = new Create_28_Suite_1_8();
