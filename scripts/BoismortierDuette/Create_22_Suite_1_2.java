 ...
 */
public class Create_22_Suite_1_2 {
  ...
  final static private String description = "Suite I, 2 Fanfare";
  final static private String number = "22";
  final static private String camelTitle = "Fanfare";
  final static private int resolution = 480;

  private Create_22_Suite_1_2() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "22_suite_1_2-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("22_suite_1_2-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_22_Suite_1_2 processor = new Create_22_Suite_1_2();
