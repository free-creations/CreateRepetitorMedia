 ...
 */
public class Create_13_NaudotSuite_1_1 {
  ...
  final static private String description = "Siute I Gracieusement";
  final static private String number = "13";
  final static private String camelTitle = "NaudotSuite1_1";
  final static private int resolution = 480;

  private Create_13_NaudotSuite_1_1() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "13_NaudotSuite1_1-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("13_NaudotSuite1_1-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_13_NaudotSuite_1_1 processor = new Create_13_NaudotSuite_1_1();
