 ...
 */
public class Create_01_Suite_1_1 {
  ...
  private Create_01_Suite_1_1() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "01_suite_1_1-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("01_suite_1_1-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_01_Suite_1_1 processor = new Create_01_Suite_1_1();
