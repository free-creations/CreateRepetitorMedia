 ...
 */
public class Create_29_Suite_1_9 {
  ...
  final static private String description = "Suite I, 2e Rigaudon";
  final static private String number = "29";
  final static private String camelTitle = "Rigaudon";
  final static private int resolution = 480;

  private Create_29_Suite_1_9() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "29_suite_1_9-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("29_suite_1_9-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_29_Suite_1_9 processor = new Create_29_Suite_1_9();
