 ...
 */
public class Create_27_Suite_1_7 {
  ...
  final static private String description = "Suite I, 7 Doucement";
  final static private String number = "27";
  final static private String camelTitle = "Doucement";
  final static private int resolution = 480;

  private Create_27_Suite_1_7() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "27_suite_1_7-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("26_suite_1_6-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_27_Suite_1_7 processor = new Create_27_Suite_1_7();
