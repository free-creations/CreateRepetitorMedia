 ...
 */
public class Create_04_Doucement {
  ...
  final static private String description = "Doucement";
  ...
  private Create_04_Doucement() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "04_Doucement-o.mid");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_04_Doucement processor = new Create_04_Doucement();
