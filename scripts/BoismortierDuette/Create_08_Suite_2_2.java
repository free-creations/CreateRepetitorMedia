 ...
 */
public class Create_08_Suite_2_2 {
  ...
  final static private String description = "Cosaques";
  final static private String number = "08";
  final static private String camelTitle = "Suite_2_2";
  final static private int resolution = 480;

  private Create_08_Suite_2_2() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "08_suite_2_2-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("08_suite_2_2-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_08_Suite_2_2 processor = new Create_08_Suite_2_2();
