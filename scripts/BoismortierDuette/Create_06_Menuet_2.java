 ...
 */
public class Create_06_Menuet_2 {
  ...
  final static private String description = "Menuet_2";
  final static private String number = "06";
  final static private String camelTitle = "Menuet_2";
  final static private int resolution = 480;

  private Create_06_Menuet_2() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "06_Menuet_2-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("06_Menuet_2-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_06_Menuet_2 processor = new Create_06_Menuet_2();
