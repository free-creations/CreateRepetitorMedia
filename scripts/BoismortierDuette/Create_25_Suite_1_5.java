 ...
 */
public class Create_25_Suite_1_5 {
  ...
  final static private String description = "Suite I, 5 Rondeau";
  final static private String number = "25";
  final static private String camelTitle = "Rondeau";
  final static private int resolution = 480;

  private Create_25_Suite_1_5() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "25_suite_1_5-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("25_suite_1_5-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_25_Suite_1_5 processor = new Create_25_Suite_1_5();
