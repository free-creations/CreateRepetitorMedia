 ...
 */
public class Create_02_Suite_1_2 {
  ...
  final static private String description = "Suite I, 2 Rondeau";
  ...
  private Create_02_Suite_1_2() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "02_suite_1_2-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("02_suite_1_2-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_02_Suite_1_2 processor = new Create_02_Suite_1_2();
