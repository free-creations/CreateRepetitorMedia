 ...
 */
public class Create_23_Suite_1_3 {
  ...
  final static private String description = "Suite I, 3 Menuet";
  final static private String number = "23";
  final static private String camelTitle = "Menuet";
  final static private int resolution = 480;

  private Create_23_Suite_1_3() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "23_suite_1_3-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("23_suite_1_3-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_23_Suite_1_3 processor = new Create_23_Suite_1_3();
