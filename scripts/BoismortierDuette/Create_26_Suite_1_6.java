 ...
 */
public class Create_26_Suite_1_6 {
  ...
  final static private String description = "Suite I, 6 Pavannne";
  final static private String number = "26";
  final static private String camelTitle = "Pavannne";
  final static private int resolution = 480;

  private Create_26_Suite_1_6() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "26_suite_1_6-o.mid");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_26_Suite_1_6 processor = new Create_26_Suite_1_6();
