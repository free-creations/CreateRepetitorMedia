 ...
 */
public class Create_09_Suite_2_3 {
  ...
  final static private String description = "Rondeau";
  final static private String number = "09";
  final static private String camelTitle = "Suite_2_3";
  final static private int resolution = 480;

  private Create_09_Suite_2_3() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "09_suite_2_3-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("09_suite_2_3-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_09_Suite_2_3 processor = new Create_09_Suite_2_3();
