 ...
 */
public class Create_24_Suite_1_4 {
  ...
  final static private String description = "Suite I, 4 Courante";
  final static private String number = "24";
  final static private String camelTitle = "Courante";
  final static private int resolution = 480;

  private Create_24_Suite_1_4() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "24_suite_1_4-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("24_suite_1_4-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_24_Suite_1_4 processor = new Create_24_Suite_1_4();
