 ...
 */
public class Create_07_Suite_2_1 {
  ...
  final static private String description = "Prelude";
  final static private String number = "07";
  final static private String camelTitle = "Suite_2_1";
  final static private int resolution = 480;

  private Create_07_Suite_2_1() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "07_suite_2_1-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("07_suite_2_1-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_07_Suite_2_1 processor = new Create_07_Suite_2_1();
