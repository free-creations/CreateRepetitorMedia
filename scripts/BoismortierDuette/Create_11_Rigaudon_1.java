 ...
 */
public class Create_11_Rigaudon_1 {
  ...
  final static private String description = "Rigaudon 1";
  final static private String number = "11";
  final static private String camelTitle = "Rigaudon_1";
  final static private int resolution = 480;

  private Create_11_Rigaudon_1() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "11_Rigaudon_1-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("11_Rigaudon_1-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_11_Rigaudon_1 processor = new Create_11_Rigaudon_1();
