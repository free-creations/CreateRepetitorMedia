 ...
 */
public class Create_14_NaudotSuite_1_2 {
  ...
  final static private String description = "Siute I Sauteuse";
  final static private String number = "14";
  final static private String camelTitle = "NaudotSuite1_2";
  final static private int resolution = 480;

  private Create_14_NaudotSuite_1_2() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "14_NaudotSuite1_2-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("14_NaudotSuite1_2-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_14_NaudotSuite_1_2 processor = new Create_14_NaudotSuite_1_2();
