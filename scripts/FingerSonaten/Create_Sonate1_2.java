...
public class Create_Sonate1_2 {
  ...
  final static private String description = "Sonate I,Poco Vivace";
  final static private String number = "2";
  final static private String camelTitle = "SonateI_2Vivace";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/FingerSonaten/resources");

  private Create_Sonate1_2() throws IOException {
    loggingHandler = null;

    orchestraFile = new File(resourceDir, "Sonate1_2VivaceOrchesta.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException(orchestraFile.getPath() + " not found.");
    }

    voicesFile = new File(resourceDir, "Sonate1_2VivaceVoices.mid");
...
//    masterSequence.getTracks()[0].add(newEndOfTrackMessage(fullSeqLen));
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_Sonate1_2 processor = new Create_Sonate1_2();
