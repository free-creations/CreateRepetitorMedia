...
public class Create_Sonate1_3 {
  ...
  final static private String description = "Sonate I, Grave";
  final static private String number = "3";
  final static private String camelTitle = "SonateI_3Grave";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/FingerSonaten/resources");

  private Create_Sonate1_3() throws IOException {
    loggingHandler = null;

    orchestraFile = new File(resourceDir, "Sonate1_3GraveOrchestra.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException(orchestraFile.getPath() + " not found.");
    }

    voicesFile = new File(resourceDir, "Sonate1_3GraveVoices.mid");
...
//    masterSequence.getTracks()[0].add(newEndOfTrackMessage(fullSeqLen));
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_Sonate1_3 processor = new Create_Sonate1_3();
