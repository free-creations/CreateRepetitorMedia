...
public class Create_Sonate1_4 {
  ...
  final static private String description = "Sonate I, Presto";
  final static private String number = "4";
  final static private String camelTitle = "SonateI_4Presto";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/FingerSonaten/resources");

  private Create_Sonate1_4() throws IOException {
    loggingHandler = null;

    orchestraFile = new File(resourceDir, "Sonate1_4PrestoOrchestra.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException(orchestraFile.getPath() + " not found.");
    }

    voicesFile = new File(resourceDir, "Sonate1_4PrestoVoices.mid");
...
//    masterSequence.getTracks()[0].add(newEndOfTrackMessage(fullSeqLen));
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_Sonate1_4 processor = new Create_Sonate1_4();
