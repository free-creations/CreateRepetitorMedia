...
public class Create_Sonate1_1 {
  ...
  final static private String piece = "FingerSonaten";
  final static private String description = "Sonate I,Poco Largo";
  final static private String number = "1";
  final static private String camelTitle = "SonateI_1PocoLargo";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/FingerSonaten/resources");

  private Create_Sonate1_1() throws IOException {
    loggingHandler = null;

    orchestraFile = new File(resourceDir, "Sonate1_1PocoLargoOrchestra.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException(orchestraFile.getPath() + " not found.");
    }

    voicesFile = new File(resourceDir, "Sonate1_1PocoLargoVoices.mid");
...
//    masterSequence.getTracks()[0].add(newEndOfTrackMessage(fullSeqLen));
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_Sonate1_1 processor = new Create_Sonate1_1();
