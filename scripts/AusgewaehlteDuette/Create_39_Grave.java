...
public class Create_39_Grave {
  ...
  final static private String description = "Telemann Grave";
  final static private String number = "39";
  ...
  private Create_39_Grave() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "39_Grave-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_39_Grave processor = new Create_39_Grave();
