 ...
 */
public class Create_36_GavottaVivace {
  ...
  final static private String description = "Valentine Allegro";
  final static private String number = "36";
  final static private String camelTitle = "GavottaVivace";
  ...
  private Create_36_GavottaVivace() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "36_GavottaVivace-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_36_GavottaVivace processor = new Create_36_GavottaVivace();
