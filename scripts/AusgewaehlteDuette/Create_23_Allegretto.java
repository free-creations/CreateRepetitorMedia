 ...
 */
public class Create_23_Allegretto {
  ...
  final static private String description = "De Fesch, Allegretto";
  final static private String number = "23";
  final static private String camelTitle = "Allegretto";
  ...
  private Create_23_Allegretto() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "23_Allegretto.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_23_Allegretto processor = new Create_23_Allegretto();
