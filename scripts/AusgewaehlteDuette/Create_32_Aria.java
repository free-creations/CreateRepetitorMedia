...
public class Create_32_Aria {
  ...
  final static private String description = "Parcham Aria";
  final static private String number = "32";
  ...
  private Create_32_Aria() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "32_Aria-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_32_Aria processor = new Create_32_Aria();
