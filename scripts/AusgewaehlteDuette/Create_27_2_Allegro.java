 ...
 */
public class Create_27_2_Allegro {
  ...
  final static private String number = "27-2";
  ...
  private Create_27_2_Allegro() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "27_2_Allegro.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_27_2_Allegro processor = new Create_27_2_Allegro();
