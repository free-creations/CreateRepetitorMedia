...
public class Create_25_Giga {
  ...
  final static private String description = "De Gant, Giga";
  ...
  private Create_25_Giga() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "25_Giga.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_25_Giga processor = new Create_25_Giga();
