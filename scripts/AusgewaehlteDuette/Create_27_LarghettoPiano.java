 ...
 */
public class Create_27_LarghettoPiano {
  ...
  final static private String description = "Händel, Larghetto";
  final static private String number = "27p";
  final static private String camelTitle = "LarghettoPiano";
  ...
  private Create_27_LarghettoPiano() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "27_LarghettoPiano.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_27_LarghettoPiano processor = new Create_27_LarghettoPiano();
