...
public class Create_37_Presto {
  ...
  final static private String description = "Finger Presto";
  final static private String number = "37";
  final static private String camelTitle = "Presto";
  ...
  private Create_37_Presto() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "37_Presto.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_37_Presto processor = new Create_37_Presto();
