 ...
 */
public class Create_28_Allegro {
  ...
  final static private String description = "Allegro";
  ...
  private Create_28_Allegro() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "28_Allegro-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_28_Allegro processor = new Create_28_Allegro();
