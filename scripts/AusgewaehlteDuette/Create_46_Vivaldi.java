 ...
 */
public class Create_46_Vivaldi {
  ...
  final static private String description = "Vivaldi";
  final static private String number = "46";
  final static private String camelTitle = "Vivaldi";
  ...
  private Create_46_Vivaldi() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "46_VivaldiOrchestra.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_46_Vivaldi processor = new Create_46_Vivaldi();
