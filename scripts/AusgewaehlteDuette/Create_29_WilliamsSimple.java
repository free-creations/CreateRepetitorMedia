 ...
 */
public class Create_29_WilliamsSimple {
  ...
  final static private String description = "Williams Simple";
  final static private String number = "29_1";
  final static private String camelTitle = "WilliamsSimple";
  ...
  private Create_29_WilliamsSimple() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "29_WilliamsSimpleOrchestra.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_29_WilliamsSimple processor = new Create_29_WilliamsSimple();
