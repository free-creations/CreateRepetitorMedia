 ...
 */
public class Create_19_RondoGrazioso {
  ...
  final static private String description = "Del La Barre, Rondo Grazioso";
  final static private String number = "19";
  final static private String camelTitle = "RondoGrazioso";
  ...
  private Create_19_RondoGrazioso() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "19_RondoGrazioso.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_19_RondoGrazioso processor = new Create_19_RondoGrazioso();
