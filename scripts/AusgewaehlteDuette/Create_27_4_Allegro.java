 ...
 */
public class Create_27_4_Allegro {
  ...
  final static private String description = "Händel, Allegro";
  final static private String number = "27-4";
  ...
  private Create_27_4_Allegro() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "27_4_Allegro.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_27_4_Allegro processor = new Create_27_4_Allegro();
