 ...
 */
public class Create_35_Allegro {
  ...
  final static private String number = "35";
  ...
  private Create_35_Allegro() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "35_Allegro-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_35_Allegro processor = new Create_35_Allegro();
