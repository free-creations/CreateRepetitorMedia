...
public class Create_21_Vivace {
  ...
  final static private String description = "William Croft Vivace";
  final static private String number = "21";
  final static private String camelTitle = "Vivace";
  ...
  private Create_21_Vivace() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "21_Vivace.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_21_Vivace processor = new Create_21_Vivace();
