 ...
 */
public class Create_27_3_Adagio {
  ...
  final static private String description = "Händel, Adagio";
  final static private String number = "27-3";
  final static private String camelTitle = "Adagio";
  ...
  private Create_27_3_Adagio() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "27_3_Adagio.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_27_3_Adagio processor = new Create_27_3_Adagio();
