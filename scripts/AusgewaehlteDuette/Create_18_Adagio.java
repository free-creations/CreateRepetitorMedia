...
public class Create_18_Adagio {
  ...
  final static private String description = "Finger, Adagio";
  ...
  private Create_18_Adagio() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "18_Adagio.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_18_Adagio processor = new Create_18_Adagio();
