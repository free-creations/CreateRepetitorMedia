 ...
 */
public class Create_22_Fanfare {
  ...
  final static private String description = "Naudot, Fanfare";
  ...
  private Create_22_Fanfare() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "22_Fanfare.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_22_Fanfare processor = new Create_22_Fanfare();
