 ...
 */
public class Create_27_Larghetto {
  ...
  final static private String camelTitle = "Larghetto";
  ...
  private Create_27_Larghetto() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "27_Larghetto.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_27_Larghetto processor = new Create_27_Larghetto();
