 ...
 */
public class Create_34_Chaconne {
  ...
  final static private String description = "Naudot Chaconne";
  final static private String number = "34";
  final static private String camelTitle = "Chaconne";
  ...
  private Create_34_Chaconne() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "34_Chaconne-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_34_Chaconne processor = new Create_34_Chaconne();
