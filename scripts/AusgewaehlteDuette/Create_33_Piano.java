...
public class Create_33_Piano {
  ...
  final static private String description = "Scarlatti Piano";
  final static private String number = "33";
  final static private String camelTitle = "Piano";
  ...
  private Create_33_Piano() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "33_Piano-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_33_Piano processor = new Create_33_Piano();
