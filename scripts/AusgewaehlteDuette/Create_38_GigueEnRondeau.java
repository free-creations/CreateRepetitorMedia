 ...
 */
public class Create_38_GigueEnRondeau {
  ...
  final static private String description = "Monteclair Gigue";
  final static private String number = "38";
  final static private String camelTitle = "GigueEnRondeau";
  ...
  private Create_38_GigueEnRondeau() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "38_Gigue_en_Rondeau.mid");
    if (!inputFile.exists()) {
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    double eighthLen = masterSequence.getResolution()/2;
    double barLen = 6 * eighthLen;
    long fullSeqLen = (long) (barLen * (Math.ceil((rawSeqLen + eighthLen) / barLen)));
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_38_GigueEnRondeau processor = new Create_38_GigueEnRondeau();
