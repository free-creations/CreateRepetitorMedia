 ...
 */
public class Create_29_Williams {
  ...
  final static private String description = "Williams Allegro";
  final static private String number = "29";
  final static private String camelTitle = "Williams";
  ...
  private Create_29_Williams() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "29_WilliamsOrchestra.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_29_Williams processor = new Create_29_Williams();
