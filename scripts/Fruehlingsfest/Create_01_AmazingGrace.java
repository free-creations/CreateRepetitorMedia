 ...
 */
public class Create_01_AmazingGrace {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "Fruehlingsfest";
  final static private String description = "Amazing Grace";
  final static private String number = "01";
  final static private String camelTitle = "AmazingGrace";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Fruehlingsfest/resources");

  private Create_01_AmazingGrace() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "Amazing-Grace-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_01_AmazingGrace processor = new Create_01_AmazingGrace();
