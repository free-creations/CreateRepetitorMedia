 ...
 * @author harald
 */
public class CreateFruehlingsfestContainer {

  private static final File tempDir = new File("../temp");
  private static final String outFilename = "Fruehlingsfest.fmc";
  ...
  private static ZipItem[] files = new ZipItem[]{
    ...
    // ---- 01_AmazingGrace.
    new ZipItem(
    new File(tempDir, "Fruehlingsfest/01_AmazingGrace.mid"),
    "Fruehlingsfest/01_AmazingGrace.mid",
    false),
    // ---- 
    new ZipItem(
    new File(tempDir, "Fruehlingsfest/01_AmazingGrace.xml"),
    "Fruehlingsfest/01_AmazingGrace.xml",
    true),
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    // ---- 02_Greensleeves.
    new ZipItem(
    new File(tempDir, "Fruehlingsfest/02_Greensleeves.mid"),
    "Fruehlingsfest/02_Greensleeves.mid",
    false),
    // ---- 
    new ZipItem(
    new File(tempDir, "Fruehlingsfest/02_Greensleeves.xml"),
    "Fruehlingsfest/02_Greensleeves.xml",
    true), //--------------------------------------------------------------------------
  };

  private CreateFruehlingsfestContainer() {
  ...
  public static void main(String[] args) throws Exception {
    CreateFruehlingsfestContainer processor = new CreateFruehlingsfestContainer();
