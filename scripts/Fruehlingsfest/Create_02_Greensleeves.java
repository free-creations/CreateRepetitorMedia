 ...
 */
public class Create_02_Greensleeves {
  ...
  final static private String description = "Greensleeves";
  final static private String number = "02";
  final static private String camelTitle = "Greensleeves";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Fruehlingsfest/resources");

  private Create_02_Greensleeves() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "GreenSleeves-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_02_Greensleeves processor = new Create_02_Greensleeves();
