 ...
 */
public class Create_04_Sanctus {
  ...
  final static private String piece = "04_1_Sanctus";
  final static private String description = "MissaAfricana Gloria";
  ...
  private Create_04_Sanctus() throws IOException {
    loggingHandler = null;
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    masterSequence = TrackMerger.process(masterSequence, inputSequence, new int[]{1, 13}, -1, null, loggingHandler); // 1 => Soprano
    masterSequence = TrackMerger.process(masterSequence, inputSequence, new int[]{2, 12}, -1, null, loggingHandler); // 2 => Alto
    masterSequence = TrackMerger.process(masterSequence, inputSequence, new int[]{3, 11}, -1, null, loggingHandler); // 3 => Bariton
...
// Write the file to disk
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_04_Sanctus processor = new Create_04_Sanctus();
