...
public class Create_03_Halleluja {
  ...
  final static private String description = "MissaAfricana Halleluja";
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    long fromTick = (long) (11 * barLen);
    long toTick = (long) (12 * barLen) - 1;

    masterSequence = MidiUtil.cut(masterSequence, fromTick, toTick);
