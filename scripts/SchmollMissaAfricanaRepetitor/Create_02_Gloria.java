...
public class Create_02_Gloria {
  ...
  final static private String piece = "02_Gloria";
  ...
  private Create_02_Gloria() throws IOException {
    loggingHandler = null;
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    masterSequence = TrackMerger.process(masterSequence, inputSequence, new int[]{1, 12}, -1, null, loggingHandler); // 1 => Soprano
    masterSequence = TrackMerger.process(masterSequence, inputSequence, new int[]{2, 11}, -1, null, loggingHandler); // 2 => Alto
...
// Write the file to disk
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_02_Gloria processor = new Create_02_Gloria();
