 ...
 */
public class Create_01Op5Nr4_6 {
  ...
  final static private String description = "Corelli Sonata 4 op5 Adagio2";
  final static private String number = "06";
  final static private String camelTitle = "Op5Nr4_6";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Corelli/resources");

  private Create_01Op5Nr4_6() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "CorelliOp5Nr4-6.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_01Op5Nr4_6 processor = new Create_01Op5Nr4_6();
