...
public class Create_22_Heissa {
  ...
  final static private String description = "Heisa, Kathreinerle";
  final static private String number = "22";
  final static private String camelTitle = "Heissa";
  ...
  private Create_22_Heissa() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "22_Heissa.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_22_Heissa processor = new Create_22_Heissa();
