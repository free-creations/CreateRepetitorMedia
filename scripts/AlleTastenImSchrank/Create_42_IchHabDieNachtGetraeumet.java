...
public class Create_42_IchHabDieNachtGetraeumet {
  ...
  final static private String description = "Ich hab die Nacht getraeumet";
  final static private String number = "42";
  final static private String camelTitle = "IchHabDieNachtGetraeumet";
  ...
  private Create_42_IchHabDieNachtGetraeumet() throws IOException {
    ...
    inputFile = new File(resourceDir, "42_IchHabDieNachtGetraeumet.mid");
    if (!inputFile.exists()) {
