 ...
 */
public class Create_42_IchHabDieNachtGetraeumetAmoll {
  ...
  final static private String description = "Ich hab die Nacht getraeumet a moll";
  final static private String number = "42";
  final static private String camelTitle = "IchHabDieNachtGetraeumetAmoll";
  ...
  private Create_42_IchHabDieNachtGetraeumetAmoll() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "42_IchHabDieNachtGetraeumetAmoll.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_42_IchHabDieNachtGetraeumetAmoll processor = new Create_42_IchHabDieNachtGetraeumetAmoll();
