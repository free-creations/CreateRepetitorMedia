 ...
 */
public class Create_20_Kookaburra {
  ...
  final static private String description = "Kookaburra";
  final static private String number = "20";
  final static private String camelTitle = "Kookaburra";
  ...
  private Create_20_Kookaburra() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "20_Kookaburra.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_20_Kookaburra processor = new Create_20_Kookaburra();
