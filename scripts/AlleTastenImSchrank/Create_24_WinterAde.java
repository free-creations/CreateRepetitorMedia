 ...
 */
public class Create_24_WinterAde {
  ...
  final static private String description = "Winter Ade";
  final static private String number = "24";
  final static private String camelTitle = "WinterAde";
  ...
  private Create_24_WinterAde() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "24_WinterAde.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_24_WinterAde processor = new Create_24_WinterAde();
