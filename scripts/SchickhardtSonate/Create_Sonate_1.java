...
public class Create_Sonate_1 {
  ...
  final static private String camelTitle = "Prelude";
  ...
  private Create_Sonate_1() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "preludio.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_Sonate_1 processor = new Create_Sonate_1();
