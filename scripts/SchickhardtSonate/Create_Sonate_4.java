...
public class Create_Sonate_4 {
  ...
  final static private String description = "Sarabande";
  final static private String number = "4";
  final static private String camelTitle = "Sarabande";
  ...
  private Create_Sonate_4() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "sarabanda.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_Sonate_4 processor = new Create_Sonate_4();
