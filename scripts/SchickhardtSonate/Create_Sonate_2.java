...
public class Create_Sonate_2 {
  ...
  final static private String description = "Courante";
  ...
  private Create_Sonate_2() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "corrente.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_Sonate_2 processor = new Create_Sonate_2();
