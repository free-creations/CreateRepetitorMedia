...
public class Create_IchSteh {
  ...
  final static private String description = "IchSteh";
  final static private String number = "02";
  final static private String camelTitle = "IchSteh";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/FelizNavidad/resources");

  private Create_IchSteh() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "IchStehAnDeinerKrippe.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_IchSteh processor = new Create_IchSteh();
