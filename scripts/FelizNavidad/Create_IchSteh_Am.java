 ...
 */
public class Create_IchSteh_Am {
  ...
  final static private String description = "IchSteh_Am";
  final static private String number = "03";
  final static private String camelTitle = "IchSteh_Am";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/FelizNavidad/resources");

  private Create_IchSteh_Am() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "IchSteh_Am.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_IchSteh_Am processor = new Create_IchSteh_Am();
