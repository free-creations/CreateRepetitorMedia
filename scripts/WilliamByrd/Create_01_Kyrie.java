...
public class Create_01_Kyrie {
  ...
  final static private String description = "Byrd Kyrie";
  final static private String number = "01";
  final static private String camelTitle = "Kyrie";
  ...
  private Create_01_Kyrie() throws IOException {
    ...
    orchestraFile = new File(resourceDir, "KyrieFluteSheet.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("KyrieFluteSheet.mid file not found.");
    }
