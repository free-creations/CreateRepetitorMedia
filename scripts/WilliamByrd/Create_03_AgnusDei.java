 ...
 */
public class Create_03_AgnusDei {
  ...
  final static private String piece = "WilliamByrd";
  final static private String description = "Byrd AgnusDei";
  final static private String number = "03";
  final static private String camelTitle = "AgnusDei";
  final static private int resolution = 480;

  private Create_03_AgnusDei() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "AgnusDeiFluteSheet.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("AgnusDeiFluteSheet.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_03_AgnusDei processor = new Create_03_AgnusDei();
