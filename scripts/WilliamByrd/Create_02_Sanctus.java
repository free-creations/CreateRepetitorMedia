 ...
 */
public class Create_02_Sanctus {
  ...
  final static private String description = "Byrd Sanctus";
  final static private String number = "02";
  final static private String camelTitle = "Sanctus";
  final static private int resolution = 480;

  private Create_02_Sanctus() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "SanctusFluteSheet.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("SanctusFluteSheet.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_02_Sanctus processor = new Create_02_Sanctus();
