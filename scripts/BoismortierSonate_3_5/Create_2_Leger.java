...
public class Create_2_Leger {
  ...
  final static private String description = "Sonate III, Legerement";
  final static private String number = "2";
  final static private String camelTitle = "Leger";
  final static private int resolution = 480;

  private Create_2_Leger() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "2_Leger-o.mid");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_2_Leger processor = new Create_2_Leger();
