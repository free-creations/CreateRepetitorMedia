...
public class Create_3_Lent {
  ...
  final static private String description = "Sonate III, Lentement";
  final static private String number = "3";
  final static private String camelTitle = "Lent";
  final static private int resolution = 480;

  private Create_3_Lent() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "3_Lent-o.mid");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_3_Lent processor = new Create_3_Lent();
