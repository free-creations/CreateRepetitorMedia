...
public class Create_8_Gigue {
  ...
  private Create_8_Gigue() throws IOException {
    ...
    orchestraFile = new File(resourceDir, "sonata5_4-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("sonata5_4-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_8_Gigue processor = new Create_8_Gigue();
