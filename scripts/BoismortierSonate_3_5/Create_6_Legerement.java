 ...
 */
public class Create_6_Legerement {
  ...
  final static private String description = "Sonate V, Allemande";
  final static private String number = "6";
  final static private String camelTitle = "Legerement";
  final static private int resolution = 480;

  private Create_6_Legerement() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "sonata5_2-o.mid");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_6_Legerement processor = new Create_6_Legerement();
