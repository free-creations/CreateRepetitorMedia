 ...
 */
public class Create_5_Allemande {
  ...
  private Create_5_Allemande() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "sonata5_1-o.mid");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_5_Allemande processor = new Create_5_Allemande();
