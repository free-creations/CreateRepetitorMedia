 ...
 */
public class Create_7_Lentement {
  ...
  final static private String description = "Sonate V, Lentement";
  final static private String number = "7";
  final static private String camelTitle = "Lentement";
  final static private int resolution = 480;

  private Create_7_Lentement() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "sonata5_3-o.mid");
    if (!orchestraFile.exists()) {
      throw new RuntimeException("sonata5_3-o.mid file not found.");
    }
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_7_Lentement processor = new Create_7_Lentement();
