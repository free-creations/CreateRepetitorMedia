...
public class Create_4_Gavotte {
  ...
  final static private String description = "Sonate III, Gavotte";
  final static private String number = "4";
  final static private String camelTitle = "Gavotte";
  final static private int resolution = 480;

  private Create_4_Gavotte() throws IOException {
    loggingHandler = null;
    ...
    orchestraFile = new File(resourceDir, "4_Gavotte-o.mid");
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_4_Gavotte processor = new Create_4_Gavotte();
