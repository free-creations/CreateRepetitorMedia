 ...
 */
public class Create_01_Allegro {
  ...
  private Create_01_Allegro() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "1_AllegroMidi-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_01_Allegro processor = new Create_01_Allegro();
