 ...
 */
public class Create_aMollLarghetto {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "FitzwilliamSonaten";
  final static private String description = "Haendel Sonata a-Moll";
  final static private String number = "a1";
  final static private String camelTitle = "aMollLarghetto";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/FitzwilliamSonaten/resources");

  private Create_aMollLarghetto() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "aMollLarghetto.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_aMollLarghetto processor = new Create_aMollLarghetto();
