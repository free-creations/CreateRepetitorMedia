 ...
 */
public class Create_03_Allegro {
  ...
  private Create_03_Allegro() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "3_AllegroOrchestra.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_03_Allegro processor = new Create_03_Allegro();
