...
public class Create_5_Inverno {
  ...
  final static private String description = "Le Quattro Stagioni, L'Inverno";
  final static private String number = "5";
  final static private String camelTitle = "Inverno";

  private Create_5_Inverno() throws IOException {
    loggingHandler = null;
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    //remove pauses
    long cutPos = findNote(orchestraSequence, 4, 0, 75);
...
//
    // transpose from Eflat to F
    orchestraSequence = MidiUtil.transpose(orchestraSequence, 2);
...
//    System.out.println("** Track 18 length " + masterSequence.getTracks()[18].ticks());
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    Create_5_Inverno processor = new Create_5_Inverno();
