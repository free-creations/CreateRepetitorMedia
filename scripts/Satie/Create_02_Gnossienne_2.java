 ...
 */
public class Create_02_Gnossienne_2 {

  private final File inputFile;
  private File outputMidiFile;
  private File outputSongFile;
  private final Handler loggingHandler;
  final static private String piece = "Satie";
  final static private String description = "E. Satie, Gnossienne No 2";
  final static private String number = "02";
  final static private String camelTitle = "Gnossienne2";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Satie/resources");

  private Create_02_Gnossienne_2() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "gnossienne_2Training.mid");
    if (!inputFile.exists()) {
  ...
  private void process() throws InvalidMidiDataException, IOException, JAXBException {
    ...
    OrchestraSynt.setSoundbankfile("../mk_1_rhodes.sf2");
    ...
    voiceBase++; //5
    newSongTrack = new MidiTrack();
    newSongTrack.setName("Right Pulses");
    newSongTrack.setMidiTrackIndex(voiceBase);
    newSongTrack.setMidiChannel(0);
    newSongTrack.setInstrumentDescription("Piano");
    newSongTrack.setMute(true);
    ...
    voiceBase++; //6
    newSongTrack = new MidiTrack();
    newSongTrack.setName("Left Pulses");
    newSongTrack.setMidiTrackIndex(voiceBase);
    newSongTrack.setMidiChannel(1);
    newSongTrack.setInstrumentDescription("Piano");
    newSongTrack.setMute(true);
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_02_Gnossienne_2 processor = new Create_02_Gnossienne_2();
