 ...
 * @author harald
 */
public class CreateSatieContainer {

  private static final File tempDir = new File("../temp");
  private static final File resourceDir = new File("scripts/Satie/resources");
  private static final String outFilename = "Satie.fmc";
  ...
  private static ZipItem[] files = new ZipItem[]{
    ...
    // ---- 2
    new ZipItem(
    new File(tempDir, "Satie/02_Gnossienne2.mid"),
    "Satie/02_Gnossienne2.mid",
    false),
    // ---- 2
    new ZipItem(
    new File(tempDir, "Satie/02_Gnossienne2.xml"),
    "Satie/02_Gnossienne2.xml",
    true), //--------------------------------------------------------------------------
  };

  private CreateSatieContainer() {
  ...
  public static void main(String[] args) throws Exception {
    CreateSatieContainer processor = new CreateSatieContainer();
