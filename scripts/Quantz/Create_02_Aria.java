...
public class Create_02_Aria {
  ...
  final static private String camelTitle = "Aria";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Quantz/resources");

  private Create_02_Aria() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "02_Aria-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_02_Aria processor = new Create_02_Aria();
