 ...
 */
public class Create_01_Preludio {
  ...
  private Create_01_Preludio() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "01_Preludio-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_01_Preludio processor = new Create_01_Preludio();
