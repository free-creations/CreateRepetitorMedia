 ...
 */
public class Create_04_Minuetto {
  ...
  final static private String camelTitle = "Minuetto";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/Quantz/resources");

  private Create_04_Minuetto() throws IOException {
    loggingHandler = null;
    inputFile = new File(resourceDir, "04_Minuetto-o.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_04_Minuetto processor = new Create_04_Minuetto();
