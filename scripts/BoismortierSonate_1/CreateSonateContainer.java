...
public class CreateSonateContainer {
  ...
  private static final String outFilename = "B_Sonate.fmc";
  ...
  private static ZipItem[] files = new ZipItem[]{
    ...
    false),
    //--------------------------------------------------------------------------
    // ---- 1_GottesWort midi file (generated with "1_B_Sonate.java")
    new ZipItem(
    new File(tempDir, "1_B_Sonate/1_B_Sonate.mid"),
    "1_B_Sonate/1_B_Sonate.mid",
    false),
    // ---- GottesWort xml file (generated with "CreateGottesWort.java")
    new ZipItem(
    new File(tempDir, "1_B_Sonate/1_B_Sonate.xml"),
    "1_B_Sonate/1_B_Sonate.xml",
    true),};
