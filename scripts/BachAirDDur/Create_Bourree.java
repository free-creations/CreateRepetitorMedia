...
public class Create_Bourree {
  ...
  final static private String description = "Bach Bouree";
  final static private String number = "4";
  final static private String camelTitle = "BachBouree";
  final static private int resolution = 480;
  static final private File resourceDir = new File("scripts/BachAirDDur/resources");

  private Create_Bourree() throws IOException {
    loggingHandler = null;

    inputFile = new File(resourceDir, "BoureeOrchestra.mid");
    if (!inputFile.exists()) {
  ...
  public static void main(String[] args) throws InvalidMidiDataException, IOException, URISyntaxException, JAXBException {
    ...
    Create_Bourree processor = new Create_Bourree();
