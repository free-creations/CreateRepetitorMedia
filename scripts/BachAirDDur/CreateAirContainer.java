 ...
 * @author harald
 */
public class CreateAirContainer {

  private static final File tempDir = new File("../temp");
  private static final String outFilename = "BachAirDDur.fmc";
  private static final File resourceDir = new File("scripts/BachAirDDur/resources");
  ...
  public static void main(String[] args) throws Exception {
    CreateAirContainer processor = new CreateAirContainer();
